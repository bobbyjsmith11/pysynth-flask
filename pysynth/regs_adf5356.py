...
def ADF5355_REG7_LE_SEL_SYNC_EDGE(x):
    return ((x) << 27)

# ADF5355_REG7_DEFAULT = 0x10000007
ADF5355_REG7_DEFAULT = 0x04000007
...
def ADF5355_REG11_VCO_BAND_HOLD(x):
    return ((x) << 24)
...
ADF5355_REG12_DEFAULT = 0xFFFFF5FC

# /* REG13 Bit Definitions */
def ADF5356_REG13_FRAC2_MSB(x):
    return (((x) & 0xFFFF) << 18)

def ADF5356_REG13_MOD2_MSB(x):
    return (((x) & 0xFFF) << 4)

ADF5356_REG13_DEFAULT = 0x0000000D
